...
def find_specific_date_column(sheets_service, target_date):
    ...
    date_short = target_date[5:7] + "/" + target_date[8:10]  # MM/DD 형식
    date_dot = target_date.replace("-", ".")  # YYYY.MM.DD 형식
...
def main():
    ...
    # 각 키워드별로 데이터 조회하고 바로 기록 (E열에 값이 있는 것만)
